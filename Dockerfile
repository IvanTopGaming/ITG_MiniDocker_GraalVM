...
# Download and extract Labs-OpenJDK 25 for GraalVM build
RUN wget https://github.com/graalvm/labs-openjdk/releases/download/25%2B26-jvmci-b01/labsjdk-ce-25+26-jvmci-b01-linux-amd64.tar.gz \
	&& tar -zxf labsjdk-ce-25+26-jvmci-b01-linux-amd64.tar.gz \
	&& rm labsjdk-ce-25+26-jvmci-b01-linux-amd64.tar.gz

# Set JAVA_HOME
ENV JAVA_HOME=/graalvm/labsjdk-ce-25-jvmci-b01
